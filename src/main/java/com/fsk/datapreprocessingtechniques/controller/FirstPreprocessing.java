...
public class FirstPreprocessing {
    ...
    public String explain() {
        return """
                ...
                <hr>
                <br>
                <strong><i>Hocam öncelikle ödevi geç göndermeme müsade ettiğiniz için çok teşekkür ederim.</i></strong>
                ...
                sınav kağıtlarına not yazan öğrenciler gibi hissettim. ((: Neyse Hocam, sizlere iyi calismalar.</strong>
                <br>
                <hr>
                <br>
                <ul>
                ...
                <br>
                <button>
                    <a href="http://localhost:8080/data-preprocessor-techniques/">UYGULAMA</a>
                </button>
